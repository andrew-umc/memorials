...
index++
slideVector[index] = new AddPDFDoc(index, "oAdamsK_page_for_book.pdf");
slideVector[index].date_time = "1997";
slideVector[index].listTitle = "Karly Adams";

index++
slideVector[index] = new AddPDFDoc(index, "Adams_Lisa_page_for_book.pdf");
slideVector[index].date_time = "2018";
slideVector[index].listTitle = "Lisa Adams";

index++
slideVector[index] = new AddPDFDoc(index, "0AlbrightJ&L.pdf");
slideVector[index].date_time = "Jeanette: 2010 & Lyle: 2011";
slideVector[index].listTitle = "Lyle & Jeanette Albright";

index++
slideVector[index] = new AddPDFDoc(index, "oAlvey_D_E_page_for_book.pdf");
slideVector[index].date_time = "Emma: 2017 & David: 2022";
slideVector[index].listTitle = "Emma & David Alvey";

index++
slideVector[index] = new AddPDFDoc(index, "0AndersonT.pdf");
slideVector[index].date_time = "2011";
slideVector[index].listTitle = "Tommy Anderson";

index++
slideVector[index] = new AddPDFDoc(index, "0Averys.pdf");
...
index++
slideVector[index] = new AddPDFDoc(index, "Baurmgardner_Marion_page_for_book.pdf");
slideVector[index].date_time = "2020";
slideVector[index].listTitle = "Marion Baumgardner";

index++
slideVector[index] = new AddPDFDoc(index, "OBesspage.pdf");
slideVector[index].date_time = "2018";
slideVector[index].listTitle = "Richard Bess";

index++
slideVector[index] = new AddPDFDoc(index, "0Best.pdf");
slideVector[index].date_time = "1963";
slideVector[index].listTitle = "E. Gay Best";

index++
slideVector[index] = new AddPDFDoc(index, "oBinnie_page_for_book.pdf");
slideVector[index].date_time = "2020";
slideVector[index].listTitle = "Diane Binney";

index++
slideVector[index] = new AddPDFDoc(index, "0Boggess.pdf");
slideVector[index].date_time = "1995";
slideVector[index].listTitle = "Jeanetta Boggess";

index++
slideVector[index] = new AddPDFDoc(index, "0BowenD_and_Charlotte_page_for_book.pdf");
slideVector[index].date_time = "David: 2014 & Charlotte: 2021";
slideVector[index].listTitle = "David & Charlotte Bowen";

index++
slideVector[index] = new AddPDFDoc(index, "0BoydR.pdf");
slideVector[index].date_time = "2014";
slideVector[index].listTitle = "Robert Boyd";

index++
slideVector[index] = new AddPDFDoc(index, "0BrewerA_page_in_book.pdf");
slideVector[index].date_time = "2016";
slideVector[index].listTitle = "Albert Brewer";

index++
slideVector[index] = new AddPDFDoc(index, "0Brown.pdf");
slideVector[index].date_time = "1963";
slideVector[index].listTitle = "Gorman Brown";

index++
slideVector[index] = new AddPDFDoc(index, "0BryanB.pdf");
slideVector[index].date_time = "2016";
...
index++
slideVector[index] = new AddPDFDoc(index, "0DeckardDoris.pdf");
slideVector[index].date_time = "2005";
slideVector[index].listTitle = "Doris Deckard";

index++
slideVector[index] = new AddPDFDoc(index, "0DeckardM.pdf");
slideVector[index].date_time = "2011";
slideVector[index].listTitle = "Myron Deckard";

index++
slideVector[index] = new AddPDFDoc(index, "0DeckardR.pdf");
slideVector[index].date_time = "2010";
slideVector[index].listTitle = "Randy Deckard";

index++
slideVector[index] = new AddPDFDoc(index, "0DeTurk.pdf");
slideVector[index].date_time = "1996";
slideVector[index].listTitle = "Karmen Deturk";

index++
slideVector[index] = new AddPDFDoc(index, "0Dexter.pdf");
slideVector[index].date_time = "1999";
slideVector[index].listTitle = "Ryan Dexter";

index++
slideVector[index] = new AddPDFDoc(index, "0Diekman.pdf");
slideVector[index].date_time = "1992";
slideVector[index].listTitle = "Dorothy Diekman";

index++
slideVector[index] = new AddPDFDoc(index, "ODirlam_James_and_Norma.pdf");
slideVector[index].date_time = "James: 2016 & Norma: 2017";
slideVector[index].listTitle = "James & Norma Dirlam";
...
index++
slideVector[index] = new AddPDFDoc(index, "0EdwardsL.pdf");
slideVector[index].date_time = "2014";
slideVector[index].listTitle = "Loraine Edwards";

index++
slideVector[index] = new AddPDFDoc(index, "OEhrlinger_page_in_book.pdf");
slideVector[index].date_time = "2020";
slideVector[index].listTitle = "Addison Ehrlinger";

index++
slideVector[index] = new AddPDFDoc(index, "0Ellis.pdf");
slideVector[index].date_time = "1991";
slideVector[index].listTitle = "Bessie Ellis";

index++
slideVector[index] = new AddPDFDoc(index, "0Erwin.pdf");
slideVector[index].date_time = "Amy: 1992 & Eldon: 2001";
slideVector[index].listTitle = "Eldon & Amy Erwin";

index++
AddListBreakToSlideVector (index, "F");

index++
slideVector[index] = new AddPDFDoc(index, "0Farmer.pdf");
slideVector[index].date_time = "Manford: 1995 & Lydia: 2008";
slideVector[index].listTitle = "Manford & Lydia Farmer";

index++
slideVector[index] = new AddPDFDoc(index, "oFinch_page_for_book.pdf");
slideVector[index].date_time = "2019";
slideVector[index].listTitle = "Marjorie Finch";

index++
slideVector[index] = new AddPDFDoc(index, "0ForestAdams.pdf");
slideVector[index].date_time = "1999";
slideVector[index].listTitle = "Anna Forest";

index++
slideVector[index] = new AddPDFDoc(index, "OFuller_M_book_pages.pdf");
slideVector[index].date_time = "2018";
slideVector[index].listTitle = "Mary Fuller";
...
index++
slideVector[index] = new AddPDFDoc(index, "Gordon_Betty_and Robert_page_for_book.pdf");
slideVector[index].date_time = "Betty: 2006 & Bob: 2020";
slideVector[index].listTitle = "Betty and Bob Gordon";

index++
slideVector[index] = new AddPDFDoc(index, "0GreenB.pdf");
slideVector[index].date_time = "2016";
...
index++
slideVector[index] = new AddPDFDoc(index, "Hammel_Sam_page_for_book.pdf");
slideVector[index].date_time = "2019";
slideVector[index].listTitle = "Sam Hammel";

index++
slideVector[index] = new AddPDFDoc(index, "0HatcherJ.pdf");
slideVector[index].date_time = "2013";
slideVector[index].listTitle = "Jack Hatcher";

index++
slideVector[index] = new AddPDFDoc(index, "0HaueisenW.pdf");
slideVector[index].date_time = "2011";
...
index++
slideVector[index] = new AddPDFDoc(index, "0HoffmanB.pdf");
slideVector[index].date_time = "1998";
slideVector[index].listTitle = "Brad Hoffman";

index++
slideVector[index] = new AddPDFDoc(index, "0HoffmanL.pdf");
slideVector[index].date_time = "2014";
...
index++
slideVector[index] = new AddPDFDoc(index, "0HuieVel.pdf");
slideVector[index].date_time = "1998";
slideVector[index].listTitle = "Velma Huie";
...
index++
slideVector[index] = new AddPDFDoc(index, "0JonesH_and_L.pdf");
slideVector[index].date_time = "Hobart: 2015 & Lois: 2017";
slideVector[index].listTitle = "Hobart & Lois Jones";

index++
slideVector[index] = new AddPDFDoc(index, "0Jones.pdf");
slideVector[index].date_time = "1990";
slideVector[index].listTitle = "Jason Jones";

index++
AddListBreakToSlideVector (index, "K");

index++
slideVector[index] = new  AddPDFDoc(index, "Karcher_and_Mullen_Memorial_Book_Page.pdf");
slideVector[index].date_time = "Susan: 2017 & James: 2017";
slideVector[index].listTitle = "Susan Karcher & James Mullen";

index++
slideVector[index] = new  AddPDFDoc(index, "0Kennedy.pdf");
slideVector[index].date_time = "Marian: 1989 & Fred: 1998";
slideVector[index].listTitle = "Marian & Fred Kennedy";

index++
slideVector[index] = new  AddPDFDoc(index, "0KepnerB&J.pdf");
...
index++;
slideVector[index] = new AddPDFDoc (index, "0Klenosky_Irwin.pdf");
slideVector[index].date_time = "2005";
...
index++;
slideVector[index] = new AddPDFDoc (index, "0Liechty.pdf");
slideVector[index].date_time = "1977";
slideVector[index].listTitle = "Sheryl Liechty";

index++;
slideVector[index] = new AddPDFDoc (index, "0LeverenzL.pdf");
slideVector[index].date_time = "2011";
slideVector[index].listTitle = "Linda Leverenz";

index++
AddListBreakToSlideVector (index, "M");

index++;
slideVector[index] = new AddPDFDoc (index, "0MartinR&B.pdf");
slideVector[index].date_time = "Ross: 2000 & Blanch: 2004";
slideVector[index].listTitle = "Ross & Blanche Martin";

index++;
slideVector[index] = new AddPDFDoc (index, "Merritt_J_B_page_for_book.pdf");
slideVector[index].date_time = "James: 1990 & Bethany: 1991";
slideVector[index].listTitle = "James & Bethany Merritt";

index++;
slideVector[index] = new AddPDFDoc (index, "0Merritt.pdf");
slideVector[index].date_time = "1999";
slideVector[index].listTitle = "Ray Merritt";

index++;
slideVector[index] = new AddPDFDoc (index, "0Miller.pdf");
slideVector[index].date_time = "Lloyd: 1968 & Helen: 1992";
slideVector[index].listTitle = "Lloyd & Helen Miller";
...
index++;
slideVector[index] = new AddPDFDoc (index, "0Moser.pdf");
slideVector[index].date_time = "2000";
slideVector[index].listTitle = "Lilly Moser";

index++;
slideVector[index] = new AddPDFDoc (index, "0Murphy.pdf");
slideVector[index].date_time = "2001";
slideVector[index].listTitle = "Mary Murphy";

index++
AddListBreakToSlideVector (index, "N");

index++;
slideVector[index] = new AddPDFDoc (index, "ONeieM_page_for_book.pdf");
slideVector[index].date_time = "2022";
slideVector[index].listTitle = "Marilyn Neie";

index++;
slideVector[index] = new AddPDFDoc (index, "ONewman_John_R_page_for_book.pdf");
slideVector[index].date_time = "2021";
slideVector[index].listTitle = "John Newman";

index++;
slideVector[index] = new AddPDFDoc (index, "0NotestineI.pdf");
slideVector[index].date_time = "2013";
slideVector[index].listTitle = "Ilah Notestine";

index++
AddListBreakToSlideVector (index, "O");
...
index++;
slideVector[index] = new AddPDFDoc (index, "0Oderkirk.pdf");
slideVector[index].date_time = "Galen: 1991 & Ida: 1994";
slideVector[index].listTitle = "Galen & Ida Oderkirk";

index++;
slideVector[index] = new AddPDFDoc (index, "0OkosL.pdf");
slideVector[index].date_time = "2005";
slideVector[index].listTitle = "Linda Okos";

index++;
slideVector[index] = new AddPDFDoc (index, "0OliverS.pdf");
slideVector[index].date_time = "1992";
...
index++;
slideVector[index] = new AddPDFDoc (index, "OPerkins_E_page_for_book.pdf");
slideVector[index].date_time = "2021";
slideVector[index].listTitle = "Emma Perkins";
...
index++;
slideVector[index] = new AddPDFDoc (index, "OPershing_Wilbur_and_Evelyn_page_for_book.pdf");
slideVector[index].date_time = "Wilbur: 2019 & Evelyn: 2022";
slideVector[index].listTitle = "Wilbur & Evelyn Pershing";
...
index++;
slideVector[index] = new AddPDFDoc (index, "0PooleR.pdf");
slideVector[index].date_time = "2006";
...
index++;
slideVector[index] = new AddPDFDoc (index, "0Segrist.pdf");
slideVector[index].date_time = "1978";
slideVector[index].listTitle = "James Segrist";
...
index++;
slideVector[index] = new AddPDFDoc (index, "0Taylor_Walt_and_Lois_page_for_book.pdf");
slideVector[index].date_time = "Walt: 2014 & Lois: 2022";
slideVector[index].listTitle = "Walt & Lois Taylor";

index++;
slideVector[index] = new AddPDFDoc (index, "OThrasher_page_for_book.pdf");
slideVector[index].date_time = "2020";
slideVector[index].listTitle = "George Thrasher";

index++;
slideVector[index] = new AddPDFDoc (index, "0Toman.pdf");
slideVector[index].date_time = "Charles: 1984 & Osie: 2003";
slideVector[index].listTitle = "Charles & Osie Toman";

index++
AddListBreakToSlideVector (index, "V");

index++;
slideVector[index] = new AddPDFDoc (index, "0VaughansCN.pdf");
slideVector[index].date_time = "Charles: 1993 & Nita: 2008";
slideVector[index].listTitle = "Charles & Nita Vaughan";
...
index++;
slideVector[index] = new AddPDFDoc (index, "0Wetzel.pdf");
slideVector[index].date_time = "1966";
slideVector[index].listTitle = "Othalia Wetzel";

index++;
slideVector[index] = new AddPDFDoc (index, "0WigginsV_and_Wilma_page_for_book.pdf");
slideVector[index].date_time = "Verlen: 2015 & Wilma: 2019";
...
slideVector[index].date_time = "2007";
slideVector[index].listTitle = "Anna Wintle";

index++;
slideVector[index] = new AddPDFDoc (index, "Woerner_Helen_mem_page.pdf");
slideVector[index].date_time = "2005";
slideVector[index].listTitle = "Helen Woerner";

index++
AddListBreakToSlideVector (index, "Y");

index++;
slideVector[index] = new AddPDFDoc (index, "0Yeh.pdf");
slideVector[index].date_time = "1991";
slideVector[index].listTitle = "Pai Tao Yeh";

index++;
slideVector[index] = new AddPDFDoc (index, "Yeh_Ching_Siang_Tang_memorial_page.pdf");
slideVector[index].date_time = "2006";
slideVector[index].listTitle = "Ching Siang Tang Yeh";
